...
const NextArrow = ({ onClick }: NextArrowsProps) => {
  ...
  return (
    <div
      ...
      } h-[24px] w-[24px] absolute xxl:left-[1120px] xl:left-[1070px] top-[-50px] cursor-pointer transform -translate-y-1/2 transition-colors duration-300 lg:left-[780px] md:left-[730px] sm:left-[580px] xs:left-[500px] xxs:left-[400px] spc3:left-[260px] left-[100px]`}
    >
