...
const PrevArrow = ({ onClick }: PrevArrowsProps) => {
  ...
  return (
    <div
      ...
      } h-[24px] w-[24px] absolute xxl:left-[1090px] xl:left-[1040px] top-[-50px] cursor-pointer transform -translate-y-1/2 transition-colors duration-300 lg:left-[750px] md:left-[700px] sm:left-[540px] xs:left-[470px] xxs:left-[370px] spc3:left-[230px] left-[70px]`}
    >
